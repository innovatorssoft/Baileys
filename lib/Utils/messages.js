...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('raw' in message && !!message.raw) {
        m = Types_1.WAProto.Message.fromObject(typeof message.raw === 'object' && message.raw !== null && !('raw' in message.raw) ? message.raw : message)
    }

    else if ('code' in message || 'table' in message || 'latex' in message || 'richResponse' in message) {
...
const generateWAMessageFromContent = (jid, message, options) => {
    ...
    if (quoted && !WABinary_1.isJidNewsletter(jid)) {
        ...
        const isVerifiedMe = contextInfo.participant === '0@s.whatsapp.net' || innerMessage[key]?.contextInfo?.participant === '0@s.whatsapp.net'
        ...
        if (!isVerifiedMe) {
            ...
            contextInfo.remoteJid = '0@s.whatsapp.net'
