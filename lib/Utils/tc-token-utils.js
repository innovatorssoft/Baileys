...
async function resolveTcTokenJid(jid, getLIDForPN) {
    ...
    const lid = await getLIDForPN((0, WABinary_1.jidNormalizedUser)(jid));
    return lid ? (0, WABinary_1.jidNormalizedUser)(lid) : (0, WABinary_1.jidNormalizedUser)(jid);
}
...
async function resolveIssuanceJid(jid, issueToLid, getLIDForPN, getPNForLID) {
    ...
    if (getPNForLID) {
        ...
        return pn ? (0, WABinary_1.jidNormalizedUser)(pn) : (0, WABinary_1.jidNormalizedUser)(jid);
    }
    return (0, WABinary_1.jidNormalizedUser)(jid);
}
...
async function storeTcTokensFromIqResult({ result, fallbackJid, keys, getLIDForPN, onNewJidStored }) {
    const tokensNode = (0, WABinary_1.getBinaryNodeChild)(result, 'tokens') ||
        (0, WABinary_1.getBinaryNodeChild)((0, WABinary_1.getBinaryNodeChild)(result, 'iq'), 'tokens');
    if (!tokensNode)
        return;
