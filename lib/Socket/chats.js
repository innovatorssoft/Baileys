...
const makeChatsSocket = (config) => {
    ...
    */
    ...
    const getUserDisclosures = async (t = 0) => {
        ...
        return WABinary_1.getBinaryNodeChildren(result, 'notice').map(n => ({ ...n.attrs }))
    }
    ...
    const signPrivateCredential = async (blindedCredential) => {
        ...
        const signedNode = WABinary_1.getBinaryNodeChild(result, 'sign_credential')
        const signedBytes = WABinary_1.getBinaryNodeChild(signedNode, 'signed_credential')
    ...
    const getPushConfig = async () => {
        ...
        return WABinary_1.getBinaryNodeChild(result, 'settings')
    }
    ...
    const toggleCallLinkWaitingRoom = async (linkToken, enabled, media = 'audio') => {
        ...
        const child = WABinary_1.getBinaryNodeChild(result, 'waiting_room_toggle')
        return child?.attrs
    }
