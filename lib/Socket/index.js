...
const makeWASocket = (config) => {
    ...
    const aiSock = (0, aigroups_1.makeAIGroupsSocket)(baseSock)
    const interopSock = (0, interop_1.makeInteropSocket)(aiSock)
...
exports.Zenbo = require("./interactive-handler").Zenbo
