...
class VoipResourceManager {
    ...
    static getMemoryStats(additional = {}) {
        const mem = process.memoryUsage();
        const activeWorkers = this.#activeWorkers;
        const relayConnections = additional.relayConnectionCount ?? additional.relayConnections ?? this.#relayConnections;
        const ffmpegProcesses = additional.ffmpegProcessCount ?? additional.ffmpegProcesses ?? this.#ffmpegProcesses;
