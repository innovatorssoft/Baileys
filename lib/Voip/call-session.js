...
class CallSession extends node_events_1.EventEmitter {
    ...
    /** @internal — true once a terminate/reject stanza for this call was sent by us */
    _endSignalSent = false;
    /** @internal — true when the peer / WhatsApp server initiated the end */
    _peerInitiatedEnd = false;
    ...
    _handleSignalingEvent = (tag, reason) => {
        ...
        if (tag === "terminate") {
            ...
            // The end was initiated by the peer/server — never echo a terminate back.
            this._peerInitiatedEnd = true;
