...
export class VoipResourceManager {
    ...
    getMemoryStats(additional = {}) {
        ...
        return {
            ...
            activeCallCount: additional.activeCallCount ?? 0,
            wasmMemoryBytes: additional.wasmMemoryBytes ?? 0,
            relayConnectionCount: additional.relayConnectionCount ?? this.#activeRelayConnections,
            ffmpegProcessCount: additional.ffmpegProcessCount ?? this.#activeFfmpegProcesses,
        };
    }
